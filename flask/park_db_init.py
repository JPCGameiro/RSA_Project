...
db.execute('insert into obu values(40.631894, -8.657776, "192.168.98.30")')
db.execute('insert into obu values(40.631810, -8.657700, "192.168.98.40")')
db.execute('insert into obu values(40.631864, -8.657742, "192.168.98.50")')
